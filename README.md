...
The goal of foofactors is to make regular expressions more exciting! It
...
devtools::install_github("WouterVerra/foofactors")
```
...
That’s exactly what `foofactors::str_split_one()` does.
